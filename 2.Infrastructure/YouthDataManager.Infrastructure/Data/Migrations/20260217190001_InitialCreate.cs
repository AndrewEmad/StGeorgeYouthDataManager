        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneFollowUp = table.Column<bool>(type: "bit", nullable: false),
                    Gender = table.Column<int>(type: "int", nullable: false),
                    FollowUpAreas = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderIndex = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastUpdateNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_AspNetUsers_ServantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CallLogs_AspNetUsers_ServantId",
                        column: x => x.ServantId,
                        principalSchema: "dbo",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        name: "FK_CallLogs_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitOutcome = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeVisits_AspNetUsers_ServantId",
                        column: x => x.ServantId,
                        principalSchema: "dbo",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HomeVisits_Students_StudentId",
                        column: x => x.StudentId,
                        principalSchema: "dbo",
                        principalTable: "Students",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallLogs_CallDate",
                schema: "dbo",
                table: "CallLogs",
                column: "CallDate");

            migrationBuilder.CreateIndex(
                name: "IX_CallLogs_ServantId",
                schema: "dbo",
                table: "CallLogs",
                column: "ServantId");

            migrationBuilder.CreateIndex(
                name: "IX_CallLogs_StudentId",
                schema: "dbo",
                table: "CallLogs",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeVisits_ServantId",
                schema: "dbo",
                table: "HomeVisits",
                column: "ServantId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeVisits_StudentId",
                schema: "dbo",
                table: "HomeVisits",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeVisits_VisitDate",
                schema: "dbo",
                table: "HomeVisits",
                column: "VisitDate");

            migrationBuilder.CreateIndex(
                name: "IX_Students_Area",
                schema: "dbo",
                table: "Students",
                column: "Area");

...
[Authorize]
public class StudentAdditionRequestsController : ControllerBase
{
    private readonly IStudentAdditionRequestService _service;

    public StudentAdditionRequestsController(IStudentAdditionRequestService service)
    {
        _service = service;
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateStudentAdditionRequestDto dto)
    {
